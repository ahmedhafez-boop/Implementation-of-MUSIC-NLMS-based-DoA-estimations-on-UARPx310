...
import math
import sip
import usrp_music_epy_block_1 as epy_block_1  # embedded python block



class usrp_music(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_music")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 196e3
        self.phase_shift = phase_shift = 174.000
        ...
        self._phase_shift_range = qtgui.Range(-180, 180, 0.1, 174.000, 200)
        ...
        self.qtgui_number_sink_0_0.set_title("Max angle")
        ...
        self.epy_block_1 = epy_block_1.music_doa(num_snapshots=100, num_signals=1, num_angles=181)
        self.blocks_phase_shift_0_0_0 = blocks.phase_shift(phase_shift, False)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ss((-1))
        self.blocks_argmax_xx_0 = blocks.argmax_fs(181)
        self.blocks_add_const_vxx_0 = blocks.add_const_ss((-90))
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 3e3, 0.5, 0, 0)
        ...
        self.connect((self.blocks_phase_shift_0_0_0, 0), (self.epy_block_1, 1))
        self.connect((self.epy_block_1, 0), (self.blocks_argmax_xx_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0_0, 0), (self.epy_block_1, 0))
...
def main(top_block_cls=usrp_music, options=None):
